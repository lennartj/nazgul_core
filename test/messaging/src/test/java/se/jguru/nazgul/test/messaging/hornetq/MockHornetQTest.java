 ...
 */
public class MockHornetQTest extends AbstractHornetQTest {
     ...
     */
    public MockHornetQTest(boolean transactedOperation) {
     ...
     */
    public MockHornetQTest(boolean transactedOperation, HornetQBroker broker) {
     ...
     * @throws javax.jms.JMSException if the connection could not be created or started.
     */
    @Override
     ...
     * @throws javax.jms.JMSException if the createSession operation failed.
     */
    @Override
