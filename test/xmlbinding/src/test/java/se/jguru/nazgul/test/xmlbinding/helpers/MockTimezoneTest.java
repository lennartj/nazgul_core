 ...
 */
public class MockTimezoneTest extends AbstractStandardizedTimezoneTest {

    public DateTimeZone activeTimeZone;

    @Override
    protected void setupSharedState() {
        super.setupSharedState();

        activeTimeZone = DateTimeZone.getDefault();
    }

    @Override
    protected void cleanupSharedState() {
        super.cleanupSharedState();
    }
}
