...
public class ThreePartCerealWithNillableAnnotationElement {
    ...
    @XmlElement(namespace = "http://cereal/ingredients/colour", nillable = true)
    ...
    public ThreePartCerealWithNillableAnnotationElement() {
    }

    public ThreePartCerealWithNillableAnnotationElement(String baseIngredient,
