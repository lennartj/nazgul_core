...
package se.jguru.nazgul.core.persistence.spi.jpa;
...
/**
 * JPA implementation of the PersistenceOperations interface, delegating
 * all operations to a wrapped EntityManager.
 *
...
public class JpaPersistenceOperations implements PersistenceOperations {
     ...
     *          if the entity could not be updated.
     */
    @Override
     ...
     * @throws se.jguru.nazgul.core.persistence.api.PersistenceOperationException
     *          if the entity could not be refreshed.
     */
    @Override
     ...
     * @throws se.jguru.nazgul.core.persistence.api.PersistenceOperationException
     *          if the entity could not be deleted.
     */
    @Override
     ...
     * @throws se.jguru.nazgul.core.persistence.api.PersistenceOperationException
     *          if a JPA-related exception occurred while performing the operation.
     */
    @Override
