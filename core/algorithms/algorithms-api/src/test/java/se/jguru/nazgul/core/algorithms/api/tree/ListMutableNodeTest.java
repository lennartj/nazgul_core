...
import se.jguru.nazgul.core.algorithms.api.tree.factory.ListPathFactory;
import se.jguru.nazgul.core.algorithms.api.tree.factory.PathFactory;
import se.jguru.nazgul.core.algorithms.api.tree.helpers.StringStringNode;
...
public class ListMutableNodeTest {
    ...
    // Shared state
    private PathFactory<String> listPathFactory;

    @Before
    public void createSharedState() {
        listPathFactory = new ListPathFactory<String>();
    }
    ...
    public void validateExceptionOnNullKey() {
        ...
        // Act & Assert
        new StringStringNode(null, "data", null, children, listPathFactory);
    }

    @Test(expected = NullPointerException.class)
    public void validateExceptionOnNullPathFactory() {

        // Assemble
        final List<Node<String, String>> children = new ArrayList<Node<String, String>>();

        // Act & Assert
        new StringStringNode(null, "data", null, children, null);
    }
    ...
    public void validateEmptyChildrenListOnNullChildrenArgument() {
        ...
        // Act
        final StringStringNode unitUnderTest = new StringStringNode("key", "data", null, null, listPathFactory);
    ...
    public void validateAddingAndRemovingChildren() {
        ...
        // Assemble
        final StringStringNode unitUnderTest = new StringStringNode("key", "data", null, null, listPathFactory);
        final StringStringNode child1 = new StringStringNode("child1", "child1_data", null, null, listPathFactory);
        final StringStringNode child2 = new StringStringNode("child2", "child2_data", null, null, listPathFactory);
    ...
    public void validateNoExceptionOnRemovingNonExistentChild() {
        ...
        final StringStringNode unitUnderTest = new StringStringNode("key", "data", null, null, listPathFactory);
        final List<Node<String, String>> children = new ArrayList<Node<String, String>>();
        final StringStringNode child = new StringStringNode("child", "childData",
                unitUnderTest, children, listPathFactory);
