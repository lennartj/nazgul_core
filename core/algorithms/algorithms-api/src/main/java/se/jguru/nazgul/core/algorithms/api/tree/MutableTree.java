 ...
 */
public interface MutableTree<T extends Serializable, KeyType extends Serializable & Comparable<KeyType>>
        extends Tree<T, KeyType> {
     ...
     */
    void add(MutableNode<T, KeyType> aNode, Path<KeyType> parentPath) throws IllegalArgumentException;
     ...
     */
    Node<T, KeyType> remove(Path<KeyType> path);
     ...
     */
    Node<T, KeyType> setRoot(Node<T, KeyType> root) throws IllegalArgumentException;
}
